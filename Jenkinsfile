    ...
    stages {
        stage('Build deb11 package') {
            steps {
                ...
                sh "mkdir -p ${deb11_name}_${deb11_version}/usr/share/gutendex-books/"
                ...
                sh "cp -vr ./src/* ${deb11_name}_${deb11_version}/usr/share/gutendex-books/"
                sh "cp -v ./requirements.txt ${deb11_name}_${deb11_version}/usr/share/gutendex-books/requirements.txt"
